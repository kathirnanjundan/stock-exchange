...
//		List<ITrade> filteredRecords = stockMapper.getTrades("Party A", "SELL","10-11-2020");
...
//		List<ITrade> filteredRecordsUnknown = stockMapper.getTrades("Party D", "SELL","10-11-2020");
//		assertEquals(new Boolean(true),filteredRecordsUnknown==null||filteredRecordsUnknown.isEmpty());
		
		//unmatched records with output
//		List<ITrade> unmatchedRecords = stockMapper.getUnmatchedTraders("Sell",500);
//		assertEquals("Party A",(unmatchedRecords.get(0).getSeller()));
		
		//unmatched records with empty output
//		List<ITrade> unmatchedRecordsUnknown = stockMapper.getUnmatchedTraders("Sell",600);
